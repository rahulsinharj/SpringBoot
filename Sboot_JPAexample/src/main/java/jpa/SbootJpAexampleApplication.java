...
/*		// Fetching all data from DB ::
 	-----------------------------------------------------------------------------------------------------*/		
		List<User> allusr = (List<User>)userRepository.findAll();	// Type cast Iterable<> to List<>
		System.out.println(allusr);			// This can now be directly ready to send as REST API response.
